...
{
    static class SaveToPdfWorker
    {
        public static void CreateDoc(PdfInfoWorker info)
        {
            ...
            foreach (var technicalMaintenanceSparePartCars in info.TechnicalMaintenanceSparePartCars)
            {
                CreateRow(new PdfRowParameters
                {
                    Table = table,
